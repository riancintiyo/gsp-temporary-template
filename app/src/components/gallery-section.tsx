...
const IMAGES = [
    { src: "/img/poster-1.webp", alt: "Students at sport activity" },
    { src: "/img/poster-2.webp", alt: "Science class session" },
    { src: "/img/poster-1.webp", alt: "Community learning program" },
    { src: "/img/poster-2.webp", alt: "Outdoor STEAM activity" },
    { src: "/img/poster-1.webp", alt: "Team building workshop" },
];
        ...
        <section className="w-full overflow-hidden py-16 lg:py-28 bg-white">
            <div className="mx-auto w-full max-w-360 px-8 lg:px-(--page-margin)">
                ...
                <div className="mb-6 text-start lg:mb-14">
                    ...
                    <h2 className="text-3xl mt-2 font-bold leading-tight text-grey-1200 sm:text-4xl lg:text-5xl">Moments That Matter</h2>
                    <p className="mx-auto mt-4 text-base text-grey-1000">Every photo tells a story — of students discovering science, teammates building trust, and communities growing stronger together.</p>
                </div>
                ...
                >
                    ...
                    {IMAGES.map((img, idx) => {
                        ...
                        return (
                            ...
                            >
                                <Image src={img.src} alt={img.alt} fill className="object-cover pointer-events-none" sizes={`${CARD_W}px`} priority={isCenter} />
